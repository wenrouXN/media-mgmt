---
name: media-mgmt
description: "管理媒体服务与资源链路（MoviePilot/下载器/HDHive/115/音乐/抖音/B站/TikTok）：认片(tmdb)、搜下影视、订阅、库内是否已有/缺集更新/播出档期追更、重复整理建议、下载进度、115转存、短链处理、听歌候选确认、服务体检。用户说我要看/找/下载/听、有没有更新、库里有没有、是不是重复、这是哪部、丢抖音/B站/115链接，或管理媒体服务时使用。"
---
